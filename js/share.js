(function($) {
  ...
  $('.facebook').on('click', function() {
      var w = 580, h = 300,
          ...
          if ((screen.width < 480) || (screen.height < 480)) {
              window.open ('https://www.facebook.com/share.php?u=https://frontend-bootstrapping.org', '', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
          } else {
              window.open ('https://www.facebook.com/share.php?u=https://frontend-bootstrapping.org', '', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
          }
  });
  ...
  $('.twitter').on('click', function() {
      var loc = encodeURIComponent('https:/frontend-bootstrapping.org'),
